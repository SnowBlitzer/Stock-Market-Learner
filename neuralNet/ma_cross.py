...
#signal are generated based on lookback periods of a time series of stock data
#when LMA exceeds SMA - sell     
#when SMA exceeds LMA - buy
#this example uses SMA as 100 days and LMA as 400 days
#we can tweak this to any time frame we want and test for best performance
